...
from dvadmin.system.views.recognition_config import RecognitionConfigInitSerializer
...
class Initialize(CoreInitialize):
    ...
    def init_recognition_config(self):
        """
        初始化识别界面表
        """
        self.init_base(RecognitionConfigInitSerializer, unique_fields=['key', 'parent', ])
